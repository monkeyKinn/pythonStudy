...
def send(tokenParams):
    headers = {
        ...
        'origin': 'https://live.yuanshuwang.com',
        'pragma': 'no-cache',
        'referer': 'https://live.yuanshuwang.com/',
    ...
    print('签到成功' if len(response.json().get('message')) == 0 else response.json().get('message'))
